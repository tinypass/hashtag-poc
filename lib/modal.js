  ...
  _createClass(modal, [{
    ...
    value: function _createAds(base) {
      ...
      jQuery(function ($) {
        ...
        var div = $("<div id=\"".concat(self.adSlotId, "\"></div>"));
    ...
    key: "init",
    value: function init(pbjsSrc, adUnits, adService, interestsTargeting, segmentsTargeting, urlTargeting, subscribeLink) {
